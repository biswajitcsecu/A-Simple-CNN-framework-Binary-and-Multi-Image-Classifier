...
#Model path
model_path='ECNN_network_wights.pth'
...
#data path
original_path1= 'data/Multifoc/color_lytro_09_1.png'  
original_path2= 'data/Multifoc/color_lytro_09_2.png'
