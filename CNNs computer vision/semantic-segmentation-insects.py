...
# # Semantic Segmentation of Insects
...
nbatch_size=32
nepochs=1
history = model.fit(X_train,Y_train,batch_size=nbatch_size,epochs=nepochs,validation_split=0.2, verbose=1,
